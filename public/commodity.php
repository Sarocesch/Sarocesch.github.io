...
<head>
    ...
    <title><?= htmlspecialchars($commodity->name) ?> - Farming Simulator 22</title>
        ...
        <div class="mb-8">
            ...
            <form action="add_price.php" method="post" class="bg-white p-4 rounded shadow-md">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="month" id="month" class="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php foreach ($prices as $price): ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap"><?= htmlspecialchars($price->month) ?></td>
